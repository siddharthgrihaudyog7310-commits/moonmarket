...
export const PRODUCTS: Product[] = [
  ...
  // actual sales. Photos are also pending; using a "coming soon" placeholder
  // graphic until real pack photos are supplied.
  {
    id: 'ajwain',
...
export const CATEGORIES = [
  ...
  { name: 'Spices', image: '/products/coming-soon.svg' },
