  ...
  return (
    <footer className="mt-24 bg-forest-600 text-cream/80">
      ...
      <div className="section py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <div className="inline-block rounded-xl bg-cream/95 px-3 py-2">
            <Logo />
          </div>
          <p className="mt-5 text-sm leading-relaxed max-w-xs text-cream/60">
            {siteConfig.description}
          </p>
          <p className="mt-4 text-xs font-semibold uppercase tracking-[0.2em] text-gold-400">
            Since 30 Years
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li><Link href="/" className="text-cream/70 hover:text-gold-300 transition-colors">Home</Link></li>
            <li><Link href="/shop" className="text-cream/70 hover:text-gold-300 transition-colors">Shop</Link></li>
            <li><Link href="/about" className="text-cream/70 hover:text-gold-300 transition-colors">About Us</Link></li>
            <li><Link href="/contact" className="text-cream/70 hover:text-gold-300 transition-colors">Contact</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-cream/70">
            ...
            <li>
              <a href={`tel:${siteConfig.phone.replace(/\s/g, "")}`} className="hover:text-gold-300 transition-colors">
                {siteConfig.phone}
              </a>
            </li>
            <li>
          ...
          <div className="mt-5 flex items-center gap-3">
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-gold-500/40 text-gold-300 transition-colors hover:bg-gold-500 hover:text-ink"
            >
      ...
      <div className="border-t border-cream/10">
        <div className="section py-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-cream/40">
          <p>© {year} {siteConfig.name}. All rights reserved.</p>
          <p className="flex items-center gap-1.5 text-gold-300/80">
